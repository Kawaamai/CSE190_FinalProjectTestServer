...
public:
	...
	void shadowRender(const glm::mat4& projection, const glm::mat4& view, const glm::mat4& toWorld, ovrHandType hand) {
		glm::mat4 rot;
		if (hand == ovrHand_Left)
			rot = lhandLocal;
		else
		...
		shadowShader.setMat4("InstanceTransform", rot * scale);
