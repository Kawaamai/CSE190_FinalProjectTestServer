...
private:
	...
	************************************************************************************/
	...
	void initAvatar(ovrSession s)
	{
		...
		_skinnedMeshProgram = Shader("../Minimal/AvatarVertexShader.glsl", "../Minimal/AvatarFragmentShader.glsl").ID;
		_skinnedMeshPBSProgram = Shader("../Minimal/AvatarVertexShader.glsl", "../Minimal/AvatarFragmentShaderPBS.glsl").ID;
		_combinedMeshProgram = Shader("../Minimal/AvatarVertexShader.glsl", "../Minimal/AvatarFragmentShader_CombinedMesh.glsl").ID;
